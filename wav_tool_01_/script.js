...
// Save adjusted WAV file
document.getElementById('saveWAV_button').addEventListener('click', function () {
  const wav = new wavefile.WaveFile();
  wav.fromScratch(1, audioBuffer.sampleRate, '24', adjustedWaveform);
  jSaver(wav.toBuffer(), firName + "_adjusted", "wav");
});
